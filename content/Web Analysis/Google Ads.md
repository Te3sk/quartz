...
2. **Conversion Rate**
  ...
  - **What a "Conversion" is:** A conversion is any meaningful action a user takeson your website that you deem valuable. It is **not** limited to a sale.
...
1. **Ad Relevance:** How closely your ad message matches the user's search query.

2. **Landing Page Experience:** The relevance, clarity, and navigability of the page users land on after clicking your ad.

3. **Expected Click-Through Rate (CTR):** **This is the most important component.** It is Google's prediction of how likely your ad is to be clicked. Since Google only makes money on clicks, it heavily rewards ads with a high expected CTR by giving them better placement and lower costs.
...
Ad Rank=(Your Max Bid)×(Your Quality Score)
...
Actual CPC=Your Quality ScoreAd Rank of the advertiser below you​+$0.01
...
CPA=Total ConversionsTotal Cost​

- **Conversion Rate:** The percentage of clicks that result in a conversion.

Conversion Rate=Total ClicksTotal Conversions​×100
...
#### **Core Functionality & Key Terminology** 📖
...
- **Bid:** The maximum amount you're willing to pay for a user action, such as a click (CPC) or a thousand impressions (CPM).

- **Targeting:** The criteria you use to define your audience (e.g., location, age, interests).

- **Extensions:** Additional information appended to your ads to provide more details and take up more space, like phone numbers (**call extensions**) or extra links to your site (**sitelink extensions**).

- **Performance Metrics (KPIs):** The data points used to measure success, such as **clicks**, **impressions**, **Click-Through Rate (CTR)**, and **conversions**.
...
![[Google Ads- Search queries based on the position in the funnel.png]]
...
### Strategic Best Practices for Match Types
